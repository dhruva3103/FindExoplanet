...
df = pd.read_csv('/home/lp-n-12/Downloads/Finding-Exoplanet-Using-Machine-Learning-main/exoplanets_2018.csv')
# print(df.head())
...
df['ExoplanetConfirmed'] = df['ExoplanetArchiveDisposition'].apply(lambda x: 2 if x == 'CONFIRMED' else 1 if x == 'CANDIDATE'
                                                                   else 0)
...
X_train, X_test, y_train, y_test = train_test_split(features, target, random_state=1, test_size=0.4)
